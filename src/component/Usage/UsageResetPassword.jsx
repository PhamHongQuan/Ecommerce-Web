...
function UsageResetPassword() {
    return (
        <div>
            ...
            <p className="sub-item-box-u" style={{ color: 'white' }}>Bước 2: Tại thư mục EmailService, nhập câu lệnh: "node EmailServer.js" để khởi chạy một máy chủ sử dụng Node.js để gửi email thông qua giao thức SMTP.</p>
