    ...
    const ShowProducts = () => {
        ...
        return (
            <>
                ...
                <div className="buttons d-flex justify-content-center mb-5 h-50 ">
                    ...
                    return (
                        <>
                            <div className="col-lg-3 col-md-4 col-sm-6 pb-3">
                                <div className="ms-3 h-100 border">
                                    ...
                                    <div className="card-body text-center">
                                        ...
                                        <div className="d-flex justify-content-center">
                                            <div className="btn-group shadow-0 mt-3 "
                        ...
                        <div className="">
                            <div className="w-100 ms-4">
                                <img src="https://donghohungthinh.com/upload/upload/Sieu-giam-gia-30-phan-tram-700.jpg"
                                     className="w-75 h-50" alt="Sunset Over the Sea"/><p className="fw-bold">Hóa đơn trên 1.000.000 giảm 30%</p>
                            </div>
                            <div className="w-100 ms-4 mt-2">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSeUtzCPN4QGnYIJpiaTOr68-6DIMWpijU4bg&s"
